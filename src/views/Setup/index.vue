<template>
  <div wh-full px-8 space-y-4>
    <div class="w-full flex justify-end">
      <div class="w1/3 flex justify-around">
        <h3 v-for="item in 5" :key="item" class="hvr-wobble-horizontal hvr-underline-from-center cursor-pointer p1">
          menu{{ item }}
        </h3>
      </div>
    </div>

    <el-button @click="clickbtn1()" class="animate__animated animate__rotateInUpLeft">
      click: isShow:{{ isShow }}
    </el-button>
    <div flex space-x-8>
      ...
      <p :class="{ boingInUp: isShow }" w40 h10 bg-pink-500 rounded text-center ma-auto>
        bombRightOut
      </p>
    </div>
    ...
    <div class="hvr-grow flex text-center relative w160 h40 cursor-pointer" :class="{ boingInUp: isShow }">
  ...
  <div class="scroll-box" @wheel="handleScroll">
    <TransitionGroup name="page" tag="div">
      <div ref="page1" class="item animate__animated bg-pink " h-full w-full></div>
      <div ref="page2" class="item animate__animated bg-yellow-4 " h-full w-full>
      </div>
      <!-- :class="isScrollTop ? 'animate__fadeInDown' : 'animate__fadeInUp'" -->
      <div ref="page3" class="item animate__animated  bg-blue-5" h-full w-full>
        333333
      </div>
    </TransitionGroup>
  </div>
