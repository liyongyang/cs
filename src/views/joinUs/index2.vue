    ...
    <div class="content">
      ...
      <div v-if="active === 0" class="tab-box">
        <div class="flex justify-between items-center">
          ...
          <li class="more" @click="toImgs()">{{ t("common.more") }} ></li>
        </div>
        <div class="conf1 wow animate__fadeInUp">
          <img src="/joinUs/us.png" alt="">
        ...
        <div class="flex justify-between items-center">
          ...
          <li class="more" @click="toMoreArticle()">{{ t("common.more") }} ></li>
        </div>
          ...
          <div class="list">
            <div class="item-conf" v-for="(item, index) in list" :key="index" @click="handlActive(index)">
              ...
              <div class="item-conf-jd">
                <li class="tips" v-if="item.conf.tip">
                  {{ t("page_joinUs.conf2.tip") }}
                </li>
                <li class="desc" v-for="(t, index) in item.conf.tip" :key="index">
                  {{ t }}
                </li>
                <li class="tips" v-if="item.conf.jd1">
                  {{ t("page_joinUs.conf2.jd1") }}
                </li>
                <li class="desc" v-for="(t, index) in item.conf.jd1" :key="index">
                  {{ index + 1 }}. {{ t }}
                </li>
                <li class="tips" v-if="item.conf.jd2">
                  {{ t("page_joinUs.conf2.jd2") }}
                </li>
                <li class="desc" v-for="(t, index) in item.conf.jd2" :key="index">
                  {{ index + 1 }}. {{ t }}
                </li>
                <li class="tips" v-if="item.conf.jd3">
                  {{ t("page_joinUs.conf2.jd3") }}
                </li>
      ...
      <div v-if="active === 1" class="join-qa wow animate__fadeInUp" @click="toQA">
        <img :src="t('page_joinUs.conf1.qaImg')" alt="" />
      </div>
    </div>
...
const tab = [t("page_joinUs.type[0]"), t("page_joinUs.type[1]")];
const active = ref(0);
const conf2Card = [
  [
...
const toMoreArticle = (index: number) => {
  router
    .push({
      path: `/joinUs/pg`,
    })
