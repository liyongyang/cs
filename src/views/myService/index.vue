    ...
    <div class="content">
      ...
      <div class="box2 wow animate__fadeInUp">
        <div
          ...
          :key="index"
          @mouseover="activeVector = index"
          @mouseleave="activeVector = -1"
        >
          <img
            :src="
              activeVector === index
                ? `/myService/icons/icon_act` + (index + 1) + `.png`
                : `/myService/icons/icon` + (index + 1) + `.png`
            "
            alt="icon"
            class="icon"
          />
      ...
      <div id="box2Ref" class="box1 wow animate__fadeInUp">
      ...
      <div class="bg1 wow animate__fadeInUp">
        ...
        <div class="btns">
          <div
            class="btn-items"
            :style="'margin-top:' + processMarginTop + 'px'"
          >
            <div
              class="btn-item"
              v-for="(item, index) in steps"
              :key="index"
              @mouseenter="toggleProcess(index, true)"
            ...
            >
              ...
              <div v-for="(t, index) in item.msg" :key="index">
                <li class="txt animate__animated animate__fadeInUp">
                  {{ index + 1 }} {{ t }}
                </li>
              </div>
            </div>
      ...
      <div id="box5Ref" class="bg4 wow animate__fadeInUp">
        ...
        <div class="card">
          <div class="item" v-for="(item, index) in list3" :key="index">
            ...
            <li class="more" @click="toDetail('case3')">
              {{ t("page_server.conf5.more") }}
            </li>
          </div>
        </div>
      ...
      <div id="box6Ref" class="bg5 wow animate__fadeInUp">
        ...
        <div class="content">
          <div class="btns">
            ...
            <div class="item" v-for="(item, index) in list4" :key="index">
              ...
              <li class="more" @click="toDetail('case4')">
                {{ t("page_server.conf6.more") }} >
              </li>
            </div>
          </div>
          <img
      ...
      <div id="box7Ref" class="bg5 wow animate__fadeInUp">
        ...
        <div class="content">
          ...
          <div class="info5">
            ...
            <li class="more5" @click="toDetail('case7')">
              {{ t("page_server.conf7.more") }} >
            </li>
          </div>
        </div>
      </div>
      <div id="box8Ref" class="bg6 wow animate__fadeInUp">
      ...
      <div id="box9Ref" class="bg6 wow animate__fadeInUp">
